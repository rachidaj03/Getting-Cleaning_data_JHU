...
# Reading all the files from the testion and training directories 

test_files<-list.files("test",recursive=TRUE)
train_files<-list.files("train",recursive=TRUE)
